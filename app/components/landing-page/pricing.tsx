...
export default function Pricing() {
    return (
        <div className="my-[150] flex flex-col items-center gap-14">
            <div className="flex flex-col items-center gap-6">
                ...
                <p className="text-content-body text-xl text-center">
                    Junte-se à comunidade de criadores profissionais já estão elevando sua <br/>
                    Presença online. Teste gratuitamente por <strong className="text-accent-pink">{TRIAL_DAYS} dias</strong>, sem compromisso!
                </p>
            </div>
            <div className="flex items-end gap-9">
                <div className="w-[304px] p-8 flex flex-col gap-7 rounded-2xl border border-border-[#1E1E1E]">
                    <div className="flex flex-col">
                        <span className="text-white font-bold text-[48px]">Mensal</span>
